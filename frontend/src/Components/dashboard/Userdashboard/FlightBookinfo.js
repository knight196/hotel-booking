...
export default function FlightBookinfo() {
...
const res = await axios.get(`/orders/flightid/${id}`)
setbooking(res.data)
}
  ...
  return (
    <div>
       {flightBook.flightBook?.map(item => (
              <div className="d-flex justify-content-between flight-booking-info">
<div>
                        <div className="p-2 m-2 bg-secondary bg-opacity-50 w-100">
        <h1>Outbound</h1>
...
<i className="fas fa-plane"></i>
    ...
    <div className="bg-secondary bg-opacity-50 m-2 w-50 p-2 h-100 flightbook-payment-details">
    <h1>Travellers</h1>
    <div className="d-flex justify-content-between align-items-center">
      <p>Adult:</p>
